...
tf.flags.DEFINE_string('X_input_dir', r'E:\data\after_spm\after_random_crop',
                       'X input directory, default: E:\\data\\after_spm\\after_random_crop')
tf.flags.DEFINE_string('Y_input_dir', r'E:\data\after_spm\after_random_crop1',
                       'Y input directory, default: E:\\data\\after_spm\\after_random_crop1')
tf.flags.DEFINE_string('X_output_file', r'E:\data\after_spm\output_of_ge\ge.tfrecords',
                       'X output tfrecords file, default: E:\\data\\after_spm\\output_of_ge\\ge.tfrecords')
tf.flags.DEFINE_string('Y_output_file', r'E:\data\after_spm\output_of_xi\xi.tfrecords',
                       'Y output tfrecords file, default: E:\\data\\after_spm\\output_of_xi\\xi.tfrecords')
