...
python export_graph.py --checkpoint_dir checkpoints/20190330-1638 \
...
tf.flags.DEFINE_string('checkpoint_dir', r'E:\data\code\circlegan_percent\checkpoints\20190414-1248', 'checkpoints directory path')
